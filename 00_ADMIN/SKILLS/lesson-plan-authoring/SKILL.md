...
### Canonical Knowledge 來源
當三至六年級教案本身已確認包含作文或實際寫作任務，例如寫人、敘事、狀物、記景、說明文、議論文、應用文、童話、童詩、審題、選材、大綱、段落、仿寫、範文分析或作文學習單時，必須先讀：

- 索引：10_KNOWLEDGE_BASE/作文教學_三至六年級/README_作文教學知識庫.md

### 啟動判定
1. 以使用者需求、教材、學習目標或教學活動中已確認存在的實際寫作任務為依據。
2. 一般國語文閱讀、語詞或文本理解活動若沒有作文／寫作產出，不因科目為國語文就自動啟動。
3. 啟動後依「年級＋文體／題材＋寫作階段」只讀本課必要部分。
4. 若來源沒有完全相同題目，可遷移相同文體與寫作結構，但不得把遷移後的新題目冒充為原教材題目。

### 與課綱知識庫的責任分工
- 作文教學知識庫提供題材、教學方法、寫作結構、鷹架與學習單。
- 核心素養、學習表現、學習內容仍以 Canonical 課綱知識庫為準。
- 作文來源中出現的舊「能力指標／課程標準」不得直接當成現行課綱。
- 學習單模板是依來源方法整理的可重用鷹架，不冒充原始教材逐字內容。

### 最低整合要求
作文契約啟動時，教案至少明確處理：
- 適合年級的文體／題材。
- 審題、選材、大綱或段落層次中與本課最相關的寫作階段。
- 至少一個可操作的寫作鷹架或學習單。
- 完稿後的賞析、修正或自我檢核方式。
- 若使用範文或仿寫，明確指出要學習的是句型、段落結構或全文組織，不把仿寫簡化為只換名詞。

### 停止規則
- Canonical 作文知識索引無法讀取 → ⏳ SOURCE_UNAVAILABLE；不得假裝已使用該教材。
- 年級、文體或寫作階段無法從來源可靠對應 → 標記 ⏳ 待確認，不自行具體化。
- 正式課綱對應仍依課綱知識庫查核；作文知識庫不得取代課綱來源。

## Cloud workflow
1. 建立 context brief 與來源／版本 ledger；若需撰寫學習表現、學習內容或學習目標，先依「課綱知識庫來源與載入契約」解析並讀取對應領域課綱；同時檢查教案是否符合「AI 素養知識庫來源與載入契約」的啟動條件，若符合則先讀 AI 素養 README 索引並按需載入相關子檔。 同時檢查是否符合「作文教學知識庫來源與載入契約」；若三至六年級教案含實際作文／寫作任務，先讀作文教學索引並依年級×文體／題材×寫作階段載入必要部分。
...
5. 建立 lesson flow、教材資源、教師／學生操作步驟；AI 素養契約已啟動時，明列 AI 使用角色、查證、標記與風險處理；作文教學契約已啟動時，明列審題／選材／大綱／段落層次等必要鷹架，以及至少一個可操作的寫作學習單或修正檢核。
...
## Verification
確認必要輸入完整、每個目標有活動與評量對應、支援未降低標準、所有外部事實可追溯、未知格式未被升級為官方格式。若教案符合 AI 素養載入條件，另確認：已讀 canonical AI 素養 README、只載入必要子檔、AI 素養面向／層級與教學主張可回溯來源、AI 角色與人類保留責任清楚、查證／標記／個資與風險規則已落入活動或評量、學生學習證據不被 AI 成品取代。 若教案符合作文教學載入條件，另確認：已讀 canonical 作文知識索引、年級與文體／題材對應可追溯、作文鷹架與學習單符合當次寫作階段、舊課綱語彙未被誤當現行課綱、來源未支持的題目或方法未被冒充為原教材內容。
...
- canonical_extension: `AI literacy on-demand loading contract + 10_KNOWLEDGE_BASE/AI素養, 2026-09-17; elementary writing on-demand loading contract + 10_KNOWLEDGE_BASE/作文教學_三至六年級, 2026-09-18`
